...
load_gist_into = (id,$target) ->
	get_gist id, (response) ->
...
# do the mouse over on the brand
$('.brand').mouseenter (e) ->
	$(this).html site_title_long

$('.brand').mouseleave (e) ->
	$(this).html site_title_short 
